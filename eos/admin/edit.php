...
<?php
$rr=$_GET['pro_id'];
$q=mysqli_query($obj->con(),"select * from tblpro where p_id=$rr");
foreach ($q as $i) {
  # code...
}
?>
...
<div class="form">
                                  <form class="cmxform form-horizontal tasi-form"  method="post" action="">
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class=" form-control" name="pname" type="text" value='<?php echo $i['p_name'];?>'>
                                          </div>
                                      </div>
...
<textarea class="form-control inputstl" rows="5" name="desc" ><?php echo $i['p_desc']?></textarea>                                          </div>
                                      </div>

                                          <div class="form-group ">
                                          <label for="firstname" class="control-label col-lg-2">Product Price</label>
                                          <div class="col-lg-10">
                                              <input class="form-control" name="pri" type="number" value='<?php echo $i['p_price']?>'>
                                          </div>
                                      </div>
          ...
          <?php     echo "<option value='".$i['c_name']."'>".$i['c_name']."</option>";
          ?>
          <?php
                      $co = $obj->getCo();
            foreach ($co as $i) {
                    ...
                    ?>
                                       ...
                                       <div class="form-group">
                                          <div class="col-lg-offset-2 col-lg-10">
                                              <input class="btn btn-success" type="submit" name="btn" value="update"></type>
                                          </div>
                                      </div>
                                  </form>
                              </div>
...
$cid=$_GET['pro_id'];
 ...
 $obj->editpro($name,$desc,$price,$company,$emp,$cid);   
